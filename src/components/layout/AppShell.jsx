...
export default function AppShell() {
 ...
 const [showMoreDrawer, setShowMoreDrawer] = useState(false)
  ...
  return (
    <div className="flex min-h-screen bg-background" style={{ overflowX: 'hidden', width: '100vw', maxWidth: '100vw' }}>
    ...
    {/* Announcements banner — centered modal style */}
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-x-hidden w-full max-w-full">
        ...
        <main className="flex-1 overflow-auto lg:pb-0" style={{ paddingBottom: 'calc(5rem + env(safe-area-inset-bottom, 0px))', paddingLeft: 'env(safe-area-inset-left, 10px)', paddingRight: 'env(safe-area-inset-right, 10px)' }}>
          <Outlet />
        </main>
      </div>

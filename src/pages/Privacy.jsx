        ...
        <div className="prose space-y-8">
          ...
          <section>
            ...
            <p className="text-textMuted leading-relaxed">
              Nooka is a grocery management platform operated from British Columbia, Canada. We help families track pantry inventory, generate AI-powered recipes, and manage grocery spending. Our services are governed by the Personal Information Protection Act (PIPA) of British Columbia and Canada's federal Personal Information Protection and Electronic Documents Act (PIPEDA).
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-textMuted leading-relaxed mb-3">
              Nooka uses Anthropic's Claude AI to generate recipe suggestions. When you request a recipe, we send anonymized health preference data to Anthropic's API — this includes dietary preferences, health goals, and age ranges, but never your name, email, or any personally identifying information.
            </p>
            <p className="text-textMuted leading-relaxed">
          ...
          <section>
            ...
            <p className="text-textMuted leading-relaxed">
              Nooka accounts are created by adults (18+). Health information for children may be added by a parent or guardian as part of a family account. We do not knowingly collect personal information directly from children under 13.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-textMuted leading-relaxed">
              We may update this Privacy Policy from time to time. We will notify you of significant changes by email or through the app. Continued use of Nooka after changes constitutes acceptance of the updated policy.
            </p>
          </section>

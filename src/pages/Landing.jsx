    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <section className="px-6 py-24">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-textMuted text-center mb-12 text-lg">Start free. Upgrade when you're ready. Cancel anytime.</p>
            ...
            {[
              ...
              },
              {
                ...
                features: [
                  ...
                  'AI photo pantry scan',
                  'Pantry starter templates',
              ...
              },
              {
                ...
                features: [
                  ...
                  'AI auto meal planning',
                  'Full week meal generator',
                  'Cuisine selector',
                  'Nutrition macros per meal',
              ...
              <div key={i} className={`rounded-card p-8 border-2 transition-all flex flex-col ${
                plan.highlight ? 'border-primary shadow-dropdown bg-white' : 'border-border bg-surface'
              }`}>
                {plan.badge && (
